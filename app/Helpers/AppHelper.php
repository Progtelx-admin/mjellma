...
{
    if (in_array($current, $list_to_check))
        return true;
    foreach ($list_to_check as $v) {
        if (version_compare($current, $v) >= 0)
            return true;
    }
    return false;
}
...
function generate_css($model)
{
    $inline_css = '';
    //Padding
    if (isset($model['padding']['t']) && $model['padding']['t'] != '')
        $inline_css .= "padding-top: " . $model['padding']['t'] . "px;";
    if (isset($model['padding']['b']) && $model['padding']['b'] != '')
        $inline_css .= "padding-bottom: " . $model['padding']['b'] . "px;";
    if (isset($model['padding']['l']) && $model['padding']['l'] != '')
        $inline_css .= "padding-left: " . $model['padding']['l'] . "px;";
    if (isset($model['padding']['r']) && $model['padding']['r'] != '')
        $inline_css .= "padding-right: " . $model['padding']['r'] . "px;";
    //Margin
    if (isset($model['margin']['t']) && $model['margin']['t'] != '')
        $inline_css .= "margin-top: " . $model['margin']['t'] . "px;";
    if (isset($model['margin']['b']) && $model['margin']['b'] != '')
        $inline_css .= "margin-bottom: " . $model['margin']['b'] . "px;";
    if (isset($model['margin']['l']) && $model['margin']['l'] != '')
        $inline_css .= "margin-left: " . $model['margin']['l'] . "px;";
    if (isset($model['margin']['r']) && $model['margin']['r'] != '')
        $inline_css .= "margin-right: " . $model['margin']['r'] . "px;";
    //Background
    if (!empty($model['background']))
        $inline_css .= "background: " . $model['background'] . ";";
