...
<div class="bravo-pagination">
    ...
    <?php if($rows->total() > 0): ?>
        <span
            class="count-string"><?php echo e(__('Showing :from - :to of :total Hotels', ['from' => $rows->firstItem(), 'to' => $rows->lastItem(), 'total' => $rows->total()])); ?></span>
    <?php endif; ?>
</div>
<?php /**PATH C:\laragon\www\mjellma\themes/BC/Hotel/Views/frontend/ajax/search-result.blade.php ENDPATH**/ ?>