...
<?php $__env->startSection('content'); ?>
    <div class="bravo_search_hotel">
        <div class="bravo_banner"
            <?php if($bg = setting_item('hotel_page_search_banner')): ?> style="background-image: url(<?php echo e(get_file_url($bg, 'full')); ?>)" <?php endif; ?>>
            <div class="container">
                <h1>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('module/hotel/js/hotel.js?_ver=' . config('app.asset_version'))); ?>">
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mjellma\themes/BC/Hotel/Views/frontend/search.blade.php ENDPATH**/ ?>