        ...
        <div class="bravo_search_map <?php echo e(setting_item_with_lang("boat_layout_map_option",false,"map_left")); ?>">
            ...
            <div class="results_item">
                ...
                <div class="listing_items ajax-search-result">
                    <?php echo $__env->make('Boat::frontend.ajax.search-result-map', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app',['container_class'=>'container-fluid','header_right_menu'=>true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u983725807/domains/rezervo24.com/themes/BC/Boat/Views/frontend/search-map.blade.php ENDPATH**/ ?>