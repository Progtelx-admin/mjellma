    ...
    <?php if(!empty($space_map_search_fields)): ?>
        <?php $__currentLoopData = $space_map_search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php switch($field['field']):
                ...
                <?php break; ?>
                <?php case ('attr'): ?>
                    <?php echo $__env->make('Layout::global.search.map.fields.attr', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php break; ?>
                <?php case ('date'): ?>
...
<?php /**PATH /home/u983725807/domains/rezervo24.com/themes/BC/Space/Views/frontend/layouts/search-map/form-search-map.blade.php ENDPATH**/ ?>