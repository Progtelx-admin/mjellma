<?php if(!empty($field['attr']) and !empty($attr = \Modules\Core\Models\Attributes::find($field['attr']))): ?>
    <?php
        ...
        if(!empty($query_attrs[$attr->id][0]))
            $selected = \Modules\Core\Models\Terms::where('slug',$query_attrs[$attr->id][0])->first();
        else $selected = false;
        $list_cat_json = [];
    ?>
    <?php if($attr): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/u983725807/domains/rezervo24.com/themes/BC/Layout/global/search/map/fields/attr.blade.php ENDPATH**/ ?>