            ...
            <div class="wrapper-more">
                ...
                <div class="render">
                    <span class="adults"><span
                            class="one <?php if($adults > 1): ?> d-none <?php endif; ?>"><?php echo e(__('1 Adult')); ?></span> <span
                            class="<?php if($adults <= 1): ?> d-none <?php endif; ?> multi"
                            data-html="<?php echo e(__(':count Adults')); ?>"><?php echo e(__(':count Adults', ['count' => request()->query('adults', 1)])); ?></span></span>
                    -
                    <span class="children">
                        <span class="one <?php if($children > 1): ?> d-none <?php endif; ?>"
                            data-html="<?php echo e(__(':count Child')); ?>"><?php echo e(__(':count Child', ['count' => request()->query('children', 0)])); ?></span>
                        <span class="multi <?php if($children <= 1): ?> d-none <?php endif; ?>"
                            data-html="<?php echo e(__(':count Children')); ?>"><?php echo e(__(':count Children', ['count' => request()->query('children', 0)])); ?></span>
                    </span>
                </div>
            </div>
        </div>
            ...
            <div class="dropdown-item-row">
                ...
                <div class="val">
                    ...
                    <span class="count-display"><input type="number" name="room"
                            value="<?php echo e(request()->query('room', 1)); ?>" min="1"></span>
            ...
            <div class="dropdown-item-row">
                ...
                <div class="val">
                    ...
                    <span class="count-display"><input type="number" name="adults"
                            value="<?php echo e(request()->query('adults', 1)); ?>" min="1"></span>
            ...
            <div class="dropdown-item-row">
                ...
                <div class="val">
                    ...
                    <span class="count-display"><input type="number" name="children"
                            value="<?php echo e(request()->query('children', 0)); ?>" min="0"></span>
...
<?php /**PATH C:\laragon\www\mjellma\themes/BC/Hotel/Views/frontend/layouts/search/fields/guests.blade.php ENDPATH**/ ?>