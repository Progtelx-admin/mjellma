            ...
            <div class="wrapper-more">
                ...
                <div class="render">
                    <span class="adults">
                        ...
                        <span class="multi @if ($adults <= 1) d-none @endif"
                            data-html="{{ __(':count Adults') }}">{{ __(':count Adults', ['count' => $adults]) }}</span>
                    </span> -
                    <span class="children">
                        <span class="one @if ($children > 1) d-none @endif"
                            data-html="{{ __(':count Child') }}">{{ __(':count Child', ['count' => $children]) }}</span>
                        <span class="multi @if ($children <= 1) d-none @endif"
                            data-html="{{ __(':count Children') }}">{{ __(':count Children', ['count' => $children]) }}</span>
                    </span>
                </div>
            </div>
        </div>
